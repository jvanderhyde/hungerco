...
<?php
    ...
    function chkCrtAcctVldty($formInfo)
    {
        ...
        {
            $isvalid['message'] = "Please fill all 6 numbers for student ID";
            $isvalid['flag'] = false;
            return $isvalid;
        }
        elseif(existsInDatabase1("students","Id",$formInfo['id']))
        {
            $isvalid['message'] = "This student ID has already been registered.  Verify your student ID and have the officer check that account";
            $isvalid['flag'] = false;
            return $isvalid;
        }
        elseif(strcmp($formInfo['pass1'],$formInfo['pass2'])!=0)
        {
            $isvalid['message'] = "Your passwords do not match.";
            $isvalid['flag'] = false;
            return $isvalid;
        }
        else
